...
const Articles =() => {
    ...
    return(
        <div>
            <Sidebar/>
            <div className="pl-20">
                <div className="p-20 pl-64 h-screen bg-teal-900">  
                    ...
                    <div className="pb-10 flex justify-between ">
                         ...
                         <a href="/Admin/New-Article"
                            class="border-2 border-green-700 bg-green-700 text-neutral-100 rounded-md px-4 py-2 m-2 transition duration-100 ease select-none hover:text-green-600 hover:bg-neutral-100">
                            + Add Article
                        </a>
                         </span>
                    </div> 
