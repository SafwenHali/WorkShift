                            ...
                            {data.map( a => {
                                ...
                                <tr className="bg-neutral-100 border-b ">
                                    <th scope="row" className="px-6 py-4 font-medium text-neutral-900 whitespace-nowrap">
                                       <a href={"/Job/"+a._id} className="hover:underline">
                                        {a.jobTitle}
                                        </a> 
                                    </th>
                                    ...
                                    <td className="px-6 py-4">
                                        <a href={"/Admin/Quiz/Edit-Job/"+a._id} className="font-medium text-blue-500  hover:underline">
                                            Edit
                                        </a>
                                    </td>
                                </tr>
