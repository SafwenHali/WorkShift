...
const SidebarInstructor = () => {
  let Menu = [
    ...
    { name: " Users", link: "/Formateur/Users", icon: "people-outline" },
    {
      name: " Contenent",
      link: "/Formateur/Manage-Contenent",
      icon: "folder-open-outline",
    },
    {
      name: " Statistics",
      link: "/Formateur/Statistics",
  ...
  return (
    // <div>
    //   <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-white-800 d">
    ...
    //         <span className="hidden text-neutral-500 lg:block">Instructor</span>
    //       </div>
    ...
    // </div>
    <div>
      <nav class="fixed top-0 z-50 w-full bg-black border-b border-gray-100 dark:bg-stone-900 dark:border-stone-600">
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
          <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
              <button
            ...
            <div class="flex items-center">
              <div class="flex items-center ml-3">
                <div>
                  <button
                    type="button"
                    class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:bg-stone-900"
                    aria-expanded="false"
      ...
      <aside
        id="logo-sidebar"
        class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-stone-900 dark:border-gray-600"
        aria-label="Sidebar"
      >
        ...
        <div className="px-6 text-center">
          ...
          <span className="hidden text-neutral-500 lg:block">Admin</span>
        </div>
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-stone-900">
