...
function useListbox(props) {
  ...
  const defaultIdGenerator = React16.useCallback((_2, index) => `${id}-option-${index}`, [id]);
...
var CircularProgress = React53.forwardRef(function CircularProgress2(inProps, ref) {
